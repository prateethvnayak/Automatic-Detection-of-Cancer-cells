...
def chanvese(I, init_mask, max_its, thresh=-1, display=False):
    I = I.astype(np.float)
    ...
    #     plt.savefig('/home/intern/PycharmProjects/segmentation/levelset_start.png', bbox_inches='tight')
    ...
    # if display:
    #     show_curve_and_phi(fig, I, phi, color)
    #     plt.savefig('/home/intern/PycharmProjects/segmentation/levelset_end.png', bbox_inches='tight')
